...
val_preprocessor = dict(
    mode="train", #"val",
    augmentation=['rotate'], # NO Augmentation during Training
    global_rot_noise=[noise_rotation, noise_rotation], # 6.25
    global_scale_noise=None,
    global_translate_std=None,
