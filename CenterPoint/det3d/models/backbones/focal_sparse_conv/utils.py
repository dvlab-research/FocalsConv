...
def sort_by_indices(features, indices):
    """
...
def check_repeat(features, indices, sort_first=False):
    """
...
def split_voxels(x, b, imps_3d, voxels_3d, kernel_offsets, mask_multi=True, topk=True, threshold=0.5):
    ...
    selected_features, selected_indices = check_repeat(selected_features, selected_indices)
    ...
    features_fore, coords_fore = check_repeat(features_fore_cat, coords_fore, sort_first=True)
